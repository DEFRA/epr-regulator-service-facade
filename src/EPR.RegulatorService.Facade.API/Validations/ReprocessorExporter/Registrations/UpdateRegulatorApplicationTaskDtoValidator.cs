...
public class UpdateRegulatorApplicationTaskDtoValidator : AbstractValidator<UpdateRegulatorApplicationTaskDto>
{
    public UpdateRegulatorApplicationTaskDtoValidator()
    {
